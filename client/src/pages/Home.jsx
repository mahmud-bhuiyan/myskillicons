    ...
    <div className="max-w-5xl mx-auto px-4">
      ...
      <div className="text-center mb-16">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 inline-block">
          <img
            src={`/api/v1/icons?i=${DEMO_ICONS.join(',')}&theme=dark&width=48&height=48&gap=12`}
            alt="demo icons"
...
{`<!-- In HTML -->
<img src="https://skillicons.dev/api/v1/icons?i=js,react,nodejs&theme=dark" />

<!-- In Markdown (README) -->
![My Skills](https://skillicons.dev/api/v1/icons?i=js,react,nodejs&theme=dark)`}
        </pre>
      </div>
